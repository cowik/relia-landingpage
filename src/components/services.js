        ...
        <section id="services" className="services">
            <div className="container">
                <div className="section-title">
                    <h2>Services</h2>
                    <h3>All in One Website Solution</h3>
                    </div>
                    <div className="row">
                    <div className="content col-xl-5 d-flex flex-column justify-content-center">
                        <img src="img/services.png" className="img-fluid" alt />
                    </div>
                            ...
                            <div className="row">
                                <div className="col-lg-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay={100}>
                                    <div className="icon-box iconbox-blue">
                                        ...
                                        <p>
                                            Beside the hardware and network solutions; with design and development expertise in diverse platforms, best-of-breed tools and techniques, combined with industry best practices, RELIA offers scalable end-to-end application development and management solutions from requirement analysis for deployment and rollout.
                                        </p>
                                    </div>
                                </div>
                                <div className="col-lg-6 d-flex align-items-stretch mt-4 mt-lg-0" data-aos="zoom-in" data-aos-delay={200}>
                                    <div className="icon-box iconbox-orange ">
                                        ...
                                        <p>
                                            We consult for high-end technology implementation at clients’ site or implementation of new technology according to the clients’ requirement or upgrading, enhancing the existing facilities in the clients end with the new technology integrated with the existing one.
                                        </p>
                                    </div>
                                </div>
                                <div className="col-lg-6 d-flex align-items-stretch mt-4" data-aos="zoom-in" data-aos-delay={300}>
                                    <div className="icon-box iconbox-pink">
                                        ...
                                        <h4><a href>Network & Infrastructure Services</a></h4>
                                        <p>
                                            Growth in the Solution Integration (SI) services market is fueled by the need for seamless business processes across an organization’s complete value chain of customers, partners, suppliers, and employees.
                                        </p>
                                    </div>
                                </div>
                                <div className="col-lg-6 d-flex align-items-stretch mt-4" data-aos="zoom-in" data-aos-delay={100}>
                                    <div className="icon-box iconbox-teal">
                                        ...
                                        <h4><a href>Hardware Sales & Support Services</a></h4>
                                        <p>
